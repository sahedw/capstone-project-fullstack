...
class FoodSpotServiceTest {
    ...
    void expectAllFoodSpots_whenAllFoodSpotsIsCalled() {
        ...
        FoodSpotUser currentUser = new FoodSpotUser("123", "sahed", "sahed1","Hamburg", expectedList, List.of(), "");
        //WHEN
    ...
    void expectNewFoodSpot_whenAddFoodSpotIsCalled() {
        ...
        FoodSpotUser currentUser = new FoodSpotUser("123", "sahed", "sahed1","Hamburg", new ArrayList<>(List.of(expected)), List.of(),"");
