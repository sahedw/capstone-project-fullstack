...
class FoodSpotControllerTest {
    ...
    void expectAllFoodSpots_whenGetRequestForAllFoodSpots() throws Exception {
        ...
        FoodSpotUser currentUser = new FoodSpotUser("123", "sahed", "sahed1", "Hamburg",List.of(firstTestFS, secondTestFS), List.of(),"");
    ...
    void expectUpdatedFoodSpot_whenPutRequestWithFoodSpot() throws Exception {
        ...
        FoodSpotUser currentUser = new FoodSpotUser("123", "sahed", "sahed1", "Hamburg",new ArrayList<>(List.of(toUpdate)), List.of(),"");
    ...
    void expectDeletedFoodSpot_whenDeleteRequestIsCalled() throws Exception {
        ...
        FoodSpotUser currentUser = new FoodSpotUser("123", "sahed", "sahed1", "Hamburg",new ArrayList<>(List.of(toDelete)), List.of(),"");
